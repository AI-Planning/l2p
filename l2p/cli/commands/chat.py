...
SYSTEM_PROMPT = (
    ...
    "  l2p schema <component> - Show JSON Schema for a PDDL component\n"
    "  l2p build domain|problem - Assemble full PDDL from JSON or files\n"
    "  l2p validate          - Validate .pddl files\n"
    "  l2p plan              - Run a planner on a domain/problem pair\n"
    ...
    "When users ask about PDDL components, guide them on using the appropriate "
    "l2p build/schema commands. When they ask about configuration issues, refer them to l2p init "
