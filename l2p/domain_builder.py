...
class DomainBuilder:
        ...
        **ctx_kwargs,
        ...
        Args:
            ...
            **ctx_kwargs: Additional context variables to inject into the prompt template
                (e.g., types=list[PDDLType], predicates=list[Predicate]).
        Returns:
    ...
    def generate_requirements(
        ...
        This is an automatic script generation so that an LLM does not have to define this.
        Args:
        ...
        Returns:
            requirements (list[Requirement]): List of Pydantic model 'Requirement'
        """
        reqs: Set[str] = {":strips"}
        ...
        requirements = [Requirement(name=r) for r in sorted_reqs]
        return requirements
