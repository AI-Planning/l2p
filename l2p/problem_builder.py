        ...
        **ctx_kwargs,
        ...
        Returns:
            A tuple containing two elements:
                - The parsed components. If a single class was requested, returns either a
                  single instance (if one was generated) or a list of instances. If multiple
                  classes were requested, returns a dictionary mapping each class to its
                  generated instances.
        ...
        for attempt in range(max_retries):
            try:
                ...
                for cls in classes:
                    ...
                    for t in tags:
                        if raw_blocks := parse_xml_tags(
                            ...
                            extracted_results[cls] = parse_component(
                ...
                # if multiple components requested, return dict
                if is_multi_class:
                    return extracted_results, llm_output

                # if single component requested, return component itself
                items = extracted_results[classes[0]]
                return (items[0] if len(items) == 1 else items), llm_output
