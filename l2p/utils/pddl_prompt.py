...
def load_default_template(folder: str, filename: str) -> str:
    ...
    """
    try:
        template_pth = importlib.resources.files('l2p.templates').joinpath(folder, filename)
...
DEF_DOMAIN_PROMPTS = SimpleNamespace(
    ...
    dur_actions = load_default_template(folder="domain", filename="prompt_durative_actions.md"),
    dur_conds   = load_default_template(folder="domain", filename="prompt_durative_conditions.md"),
    dur_effects = load_default_template(folder="domain", filename="prompt_durative_effects.md"),
...
DEF_PROBLEM_PROMPTS = SimpleNamespace(
    ...
    initial     = load_default_template(folder="problem", filename="prompt_initial_states.md"),
    goal        = load_default_template(folder="problem", filename="prompt_goal_states.md"),
    constraints = load_default_template(folder="problem", filename="prompt_constraints.md"),
