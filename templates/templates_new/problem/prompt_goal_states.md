...
## RULES
1. The JSON block above is strictly an ILLUSTRATIVE EXAMPLE. Do not copy names like "rover1", "waypoint3", or "pref_visit_wp4" 
    unless they are explicitly defined in the problem description. You must extract the actual predicates and objects from the text.
