...
## RULES
1. The JSON block above is strictly an ILLUSTRATIVE EXAMPLE. Do not copy names like "rover1", "battery-level", or "pref_visit_early" 
  unless they are explicitly defined in the problem description. You must extract the actual predicates, functions, and objects from the text.
...
6. Problem-level constraints typically apply to specific object instances (e.g., `rover1`). Do NOT prefix instantiated object names with a question mark (`?`).
