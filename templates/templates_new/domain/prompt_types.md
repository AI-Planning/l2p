...
## RULES
1. The JSON block above is strictly an ILLUSTRATIVE EXAMPLE. Do not copy names like "vehicle" or "rover" 
  unless they are explicitly defined in the domain description. You must extract the actual types and type hierarchies from the text.
