...
## RULES
1. The JSON block above is strictly an ILLUSTRATIVE EXAMPLE. Do not copy names like "battery-level", "total-cost", or "rover" unless they are explicitly defined in the domain description. You must extract the actual numeric functions and parameters from the text.
