...
## RULES
1. The JSON block above is strictly an ILLUSTRATIVE EXAMPLE. Do not copy names like "?r", "?from", "rover", or "waypoint" 
...
8. If there are no parameters, return an empty array:
